...
NSString *const PLAY_FAILED_ERROR = @"Playing song failed. Please try again later!";
NSString *const STOP_FAILED_ERROR = @"Stopping song failed . Please try again later!";
